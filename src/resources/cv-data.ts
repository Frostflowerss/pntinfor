...
export type CVSkill = {
  ...
  /** Optional: override percentage shown in skill bars */
  percent?: number;
};
...
export const cv = {
  ...
  softwareSkills: {
    left: [
      { name: "Autodesk Revit", level: "Expert", percent: 92 },
      { name: "Autodesk Naviswork", level: "Expert", percent: 90 },
      { name: "Autodesk AutoCAD", level: "Beginner", percent: 35 },
      { name: "Sketch Up", level: "Beginner", percent: 35 },
      { name: "Lumion", level: "Skillful", percent: 68 },
    ] satisfies CVSkill[],
    right: [
      { name: "Adobe Photoshop", level: "Expert", percent: 90 },
      { name: "Adobe Illustrator", level: "Experienced", percent: 78 },
      { name: "Adobe InDesign", level: "Experienced", percent: 78 },
      { name: "Microsoft Power BI", level: "Experienced", percent: 78 },
      { name: "Microsoft Office", level: "Experienced", percent: 78 },
    ] satisfies CVSkill[],
  },
