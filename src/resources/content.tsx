...
import { SoftwareSkillsBars } from "@/components/about/SoftwareSkillsBars";
...
const about: About = {
  ...
  intro: {
    ...
    description: (
      <>
        <Text as="span">{cv.professionalSummary.vi}</Text>
        <br />
        <br />
        <Text as="span" onBackground="brand-medium">
          {cv.professionalSummary.en}
        </Text>
      </>
    ),
  },
  work: {
    ...
    experiences: cv.employmentHistory.map((e, i) => ({
      company: e.company,
      timeframe: e.timeframe,
      role: e.role,
      achievements: e.achievements.map((a) => <>{a}</>),
      images: i === 0 ? ["/images/projects/project-01/cover-03.jpg"] : [],
    })),
  },
  studies: {
    display: true, // set to false to hide this section
  ...
  technical: {
    ...
    skills: [
      {
        title: "Software Skills",
        description: <SoftwareSkillsBars />,
        tags: [],
        images: i === 0 ? ["/images/projects/project-01/cover-03.jpg"] : [],
      },
    ],
