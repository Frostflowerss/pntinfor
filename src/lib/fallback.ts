...
function skill(title: string, level: SkillLevel, i: number, shortTitle = "") {
  return { id: `s-${i}`, title, shortTitle, level, percent: levelPercent[level], sortOrder: i };
}
...
export const fallbackData: SiteData = {
  profile: {
    ...
    sheetId: "CV-01",
    revision: "",
    spineRoles: "ARCHITECT · BIM COORDINATOR · BIM MANAGER",
    spineServices: "BIM MODELING · BIM CONSULTANT · BIM SOLUTION",
    updatedAt: "",
  },
  experiences: [
    {
  ...
  education: [
    {
      ...
      endYear: 2021,
      kind: "degree",
      shortVI: "Cử nhân Kiến trúc",
      shortEN: "The degree of Architect",
      issuer: "Ha Noi Architectural University",
      sortOrder: 0,
    },
    {
      id: "ed-1",
      ...
      endYear: null,
      kind: "course",
      shortVI: "Điều phối BIM",
      shortEN: "BIM Coordinator",
      issuer: "Vecas – Autodesk",
      sortOrder: 1,
    },
    {
      id: "ed-2",
  ...
  skills: [
    skill("Autodesk Revit", "Expert", 0, "Revit"),
    skill("Autodesk Navisworks", "Expert", 1, "Navisworks"),
    skill("Adobe Photoshop", "Expert", 2, "Photoshop"),
    skill("Microsoft Power BI", "Experienced", 3, "Power BI"),
    skill("Adobe Illustrator", "Experienced", 4, "Illustrator"),
    skill("Adobe InDesign", "Experienced", 5, "InDesign"),
    skill("Microsoft Office", "Experienced", 6, "MS Office"),
    skill("Lumion", "Skillful", 7),
    skill("Autodesk AutoCAD", "Beginner", 8, "AutoCAD"),
