    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="shell pb-20 pt-10 sm:pb-28">
        ...
        >
          ...
          {[profile.spineRoles || profile.role, profile.locationLabel].filter(Boolean).join(" · ")}
        </motion.div>
        ...
        <div className="grid items-end gap-12 lg:grid-cols-[1.4fr_1fr]">
          ...
          <motion.div
            ...
            className="relative aspect-[4/5] w-full max-w-sm justify-self-center overflow-hidden rounded-2xl border border-[var(--line)] lg:justify-self-end"
          >
            <SmartImage
