...
export function WorkCarousel() {
  ...
  const next = () => scrollToIndex(Math.min(workProjects.length - 1, activeIndex + 1));

  return (
    <Column fillWidth gap="m" paddingTop="l">
      <Row fillWidth paddingX="l" paddingBottom="s">
      ...
      {activeProject && (
        <div key={activeProject.id} className={styles.metaPanel}>
          <div className={styles.metaLeft}>
            ...
            <div className={styles.tag}>
              <BilingualBlock
                vi={activeProject.constructionClassVI}
                en={activeProject.constructionClassEN}
                mutedEN
              />
            </div>
