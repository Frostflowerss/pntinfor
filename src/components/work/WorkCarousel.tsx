...
export function WorkCarousel() {
  ...
  // Swipe (mobile + trackpad-like touch) — keep it lightweight and independent from scroll.
  const swipeRef = useRef<{
    ...
    lastX: number;
    moved: boolean;
  }>({ active: false, startX: 0, startY: 0, lastX: 0, moved: false });
      ...
      <div className={styles.featuredWrap}>
        ...
        <div
          ...
          onPointerMove={(e) => {
            ...
            // Mark as moved when it looks like horizontal intent.
            if (Math.abs(dx) > 8 && Math.abs(dx) > Math.abs(dy)) {
              swipeRef.current.moved = true;
              // Prevent selecting text / ghost drag.
          ...
          onPointerUp={(e) => {
            ...
            // Ignore if mostly vertical or not moved enough.
