...
export async function Footer() {
  ...
  return (
    <footer className="no-print relative isolate mt-32 overflow-hidden border-t border-[var(--line)]">
      <BackgroundFX variant="footer" />
      <div className="shell flex flex-col gap-10 py-14">
        <div className="flex flex-col justify-between gap-8 sm:flex-row sm:items-end">
          <div>
            ...
            <MaskReveal as="h2" className="mt-3 font-display text-3xl tracking-tight sm:text-4xl">
              {profile.name}
            </MaskReveal>
