...
constructionClass: "I"
location: "Ha Noi"
rolePrimary: "BIM Coordinator"
summaryVi: "Mô tả dự án (VI) — cập nhật nội dung theo dự án thực tế."
summaryEn: "Project summary (EN) — replace with real project details."
