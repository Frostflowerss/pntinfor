...
- **Trang CV** (`/about`): luôn mở ở **Compact** — tờ "schedule sheet" 1440×900 (một màn hình, trục thời gian 2016 → nay); bấm **DETAIL** để xem bản dài; VI / EN đổi ngôn ngữ; `?view=detail&lang=en` chia sẻ được.
